...
{
    public class CosmosDbThingyGetWithLinqQueryHandler : IQueryHandler<CosmosDbThingyGetWithLinqQuery, IOrderedQueryable<CosmosDbThingyReadModel>>
    {
        ...
        public Task<IOrderedQueryable<CosmosDbThingyReadModel>> ExecuteQueryAsync(CosmosDbThingyGetWithLinqQuery query, CancellationToken cancellationToken)
        {
