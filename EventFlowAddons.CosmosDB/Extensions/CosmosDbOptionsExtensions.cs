    ...
    public static class CosmosDbOptionsExtensions
    {
            ...
            Func<Database> databaseFactory)
        {
            ...
            eventFlowOptions.ServiceCollection
                .TryAddSingleton<IReadModelDescriptionProvider, ReadModelDescriptionProvider>();
            eventFlowOptions.ServiceCollection
                .TryAddSingleton<ICosmosDbEventSequenceStore, CosmosDbEventSequenceStore>();
        ...
        {
            eventFlowOptions.ServiceCollection
                .TryAddTransient<ICosmosDbReadModelStore<TReadModel>, CosmosDbReadModelStore<TReadModel>>();
            eventFlowOptions.ServiceCollection.TryAddTransient<IReadModelStore<TReadModel>>(r =>
                r.GetService<ICosmosDbReadModelStore<TReadModel>>() ?? throw new InvalidOperationException());
